...
describe('Tree Component', () => {
  test('renders tree with data', () => {
    render(<Tree treeData={treeData} testId="tree" />);
  ...
  test('applies custom className', () => {
    render(<Tree treeData={treeData} className="custom-tree" testId="tree" />);
  ...
  test('calls onSelect when node is selected', () => {
    ...
    render(<Tree treeData={treeData} onSelect={handleSelect} defaultExpandAll />);
  ...
  test('calls onCheck when checkbox is clicked', () => {
    ...
    render(<Tree treeData={treeData} checkable onCheck={handleCheck} defaultExpandAll />);
